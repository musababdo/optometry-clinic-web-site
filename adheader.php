    ...
    <nav class="navbar clearHeader">
        <div class="col-12">
            <div class="navbar-header"> <a href="javascript:void(0);" class="bars"></a> <a class="navbar-brand"
                    href="#">مركز منال عووضه للبصريات</a> </div>
        ...
        <aside id="leftsidebar" class="sidebar">
            ...
            <div class="menu">
                <ul class="list" style="overflow: hidden; width: auto; height: calc(-184px + 100vh);">
                    <li class="header">خدمات اللوحه</li>
                    <li class="active open"><a href="adminaccount.php"><i
                                class="zmdi zmdi-home"></i><span>الرئيسيه</span></a></li>


                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>الملف الشخصي</span> </a>
                        <ul class="ml-menu">
                            <!-- <li><a href="adminprofile.php">الملف الشخصي للمسؤول</a></li> -->
                            <!-- <li><a href="adminchangepassword.php">تغيير كلمه المرور</a></li> -->
                            <li><a href="admin.php">اضافه مسؤول</a></li>
                            <li><a href="viewadmin.php">عرض الكل</a></li>
                        </ul>
                    </li>

                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>المعرض</span> </a>
                        <ul class="ml-menu">
                            <!-- <li><a href="adminprofile.php">الملف الشخصي للمسؤول</a></li> -->
                            <!-- <li><a href="adminchangepassword.php">تغيير كلمه المرور</a></li> -->
                            <li><a href="addshow.php">اضافه</a></li>
                            <li><a href="viewshow.php">عرض الكل</a></li>
                        </ul>
                    </li>

                    <li><a href="javascript:void(0);" class="menu-toggle"><i
                                class="zmdi zmdi-calendar-check"></i><span>الحجوزات</span> </a>
                        <ul class="ml-menu">
                            <!-- <li><a href="appointment.php">New Appointment</a></li> -->
                            <li><a href="viewappointmentpending.php">عرض الكل</a>
                            </li>
