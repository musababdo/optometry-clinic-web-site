...
{	
	$sql = "SELECT * FROM login WHERE name='$_POST[username]' AND password='$_POST[password]'";
...
?></div>
    ...
    <div class="card">
        <h1 class="title"><span>مركز منال عووضه</span>تسجيل الدخول <span class="msg">تسجيل الدخول لبدء الجلسة الخاصة بك</span></h1>
        <div class="col-md-12">

    <form method="post" action="" name="frmadminlogin" id="sign_in" onSubmit="return validateform()">
    <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-account"></i> </span>
                    <div class="form-line">
					<input type="text" name="username" id="username" class="form-control" placeholder="اسم المستخدم" /></div>
                </div>
                <div class="input-group"> <span class="input-group-addon"> <i class="zmdi zmdi-lock"></i> </span>
                    <div class="form-line">
					<input type="password" name="password" id="password" class="form-control"  placeholder="كلمه المرور" /> </div>
                </div>
                <div>
                    <!-- <div class="">
					...
					<input type="submit" name="submit" id="submit" value="تسجيل دخول" class="btn btn-raised waves-effect g-bg-cyan" /></div>
